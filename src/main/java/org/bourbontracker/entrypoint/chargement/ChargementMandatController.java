...
import org.bourbontracker.entrypoint.chargement.mapper.ChargementMandatMapper;
...
public class ChargementMandatController {

    @Inject
    ChargementMandatMapper mapper;

    @POST
    @Path("/mandats")
    @Transactional
    public Response importMandat(ChargementMandatRequete req) {
