...
import org.bourbontracker.entrypoint.chargement.requete.ChargementMandatRequete;
...
public abstract class ChargementMandatMapper {
    ...
    public abstract void updateFromDto(ChargementMandatRequete src, @MappingTarget MandatEntity target);

    @AfterMapping
    protected void attachRefs(ChargementMandatRequete src, @MappingTarget MandatEntity target) {
    ...
    protected java.time.LocalDate firstSuppleantDateDebut(ChargementMandatRequete.MandatJson mandat) {
        ChargementMandatRequete.Suppleant suppleant = firstSuppleant(mandat);
        return suppleant == null ? null : suppleant.dateDebut;
    }

    @Named("firstSuppleantDateFin")
    protected java.time.LocalDate firstSuppleantDateFin(ChargementMandatRequete.MandatJson mandat) {
        ChargementMandatRequete.Suppleant suppleant = firstSuppleant(mandat);
        return suppleant == null ? null : suppleant.dateFin;
    }

    @Named("firstSuppleantRef")
    protected String firstSuppleantRef(ChargementMandatRequete.MandatJson mandat) {
        ChargementMandatRequete.Suppleant suppleant = firstSuppleant(mandat);
    ...
    private ChargementMandatRequete.Suppleant firstSuppleant(ChargementMandatRequete.MandatJson mandat) {
